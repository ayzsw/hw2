...
public class HelloApplication extends Application {
    ...
    private static ArrayList<TotalMonthSales> monthSales = new ArrayList<>();
    @Override
    ...
    public static void readExcelFile(File file) throws IOException {
        ...
        for (Row row : sheet) {
            ...
            String month = date.format(DateTimeFormatter.ofPattern("А"));

            boolean found = false;
            for (TotalMonthSales item : monthSales) {
            ...
            if (!found) {
                monthSales.add(new TotalMonthSales(month, totalPrice ));
            }
        }
    }
